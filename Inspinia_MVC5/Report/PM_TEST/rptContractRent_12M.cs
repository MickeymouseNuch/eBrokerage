...
namespace rptConnection {
    ...
    public class rptContractRent_12M : ReportClass {
        
        public rptContractRent_12M() {
        }
        
        public override string ResourceName {
            get {
                return "rptContractRent_12M.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "rptConnection.rptContractRent_12M.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptContractRent_12M : Component, ICachedReport {
        
        public CachedrptContractRent_12M() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptContractRent_12M rpt = new rptContractRent_12M();
            rpt.Site = this.Site;
            return rpt;
        }
