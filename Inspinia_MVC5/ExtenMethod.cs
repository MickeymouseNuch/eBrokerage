...
namespace Inspinia_MVC5
{
    ...
    {
        //CultureInfo IsCul = new CultureInfo("en-GB");

        public static string ToTHMonth(this DateTime val)
        {
            CultureInfo ThaiCul = new CultureInfo("th-TH");
            var _TMonth = val.ToString("MMMM", ThaiCul);
            var _Foo = val.Day + " " + _TMonth + " " + val.Year;
            return _Foo;
        }
        ...
        public static string ToTHDatetime(this DateTime val)
        {
            ...
            result = _Day.ToString() + " " + _Month.ToMonthThai() + " " + (_Year < 2200 ? _Year += 543 : _Year);

            return result;
        }

        public static string ToTHSubDatetime(this DateTime val)
        {
            string result = string.Empty;
            int _Day = val.Day;
            int _Month = val.Month;
            ...
            result = _Month.ToMonthThaiSub() + " " + (_Year < 2200 ? _Year += 543 : _Year).ToString().Substring(2,2);

            return result;
        }

        public static string ToMonthThai(this int month)
        {
            string result = string.Empty;            
            switch(month)
            {
                case 1: result = "มกราคม"; break;
                case 2: result = "กุมภาพันธ์"; break;
                case 3: result = "มีนาคม"; break;
                case 4: result = "เมษายน"; break;
                case 5: result = "พฤษภาคม"; break;
                case 6: result = "มิถุนายน"; break;
                case 7: result = "กรกฎาคม"; break;
                case 8: result = "สิงหาคม"; break;
                case 9: result = "กันยายน"; break;
        ...
        public static string ToMonthThaiSub(this int month)
        {
            string result = string.Empty;
            switch (month)
            {
                case 1: result = "ม.ค."; break;
                case 2: result = "ก.พ."; break;
                case 3: result = "มี.ค."; break;
                case 4: result = "เม.ย."; break;
                case 5: result = "พ.ค."; break;
                case 6: result = "มิ.ย."; break;
                case 7: result = "ก.ค."; break;
                case 8: result = "ส.ค."; break;
                case 9: result = "ก.ย."; break;
                case 10: result = "ต.ค."; break;
                case 11: result = "พ.ย."; break;
                case 12: result = "ธ.ค."; break;
            }
            return result;
        }
        ...
        public static string ToDatetimeFomat(this object val,string format)
        {
            CultureInfo cul = new CultureInfo("en-GB");
            try
            {
                return (Convert.ToDateTime(val, cul).ToString(format));
            }
            catch{ return Convert.ToDateTime(DateTime.MinValue, cul).ToString(format); }
        }

        public static string ToDatetimeDisplayAD(this object val,bool IsShowtime)
        {
            ...
            if(IsShowtime)
            {
                try
                {
                    return (Convert.ToDateTime(val, cul).ToString("dd/MM/yyyy HH:mm:ss"));
                }
                catch { return Convert.ToDateTime(DateTime.MinValue, cul).ToString("dd/MM/yyyy HH:mm:ss"); }
            }
            else
            {
                try
                {
                    return (Convert.ToDateTime(val, cul).ToString("dd/MM/yyyy"));
                }
                catch { return Convert.ToDateTime(DateTime.MinValue, cul).ToString("dd/MM/yyyy"); }
            }            
        }

        public static string ToDatetimeDisplayBE(this object val, bool IsShowtime)
        {
            CultureInfo cul = new CultureInfo("th-TH");
            if (IsShowtime)
            {
                try
                {
        ...
        public static DateTime ToDatetime(this object val)
        {
            ...
            try
            {
                return (Convert.ToDateTime(val, cul));
            }
            catch { return Convert.ToDateTime(DateTime.MinValue, cul); }
        }

        public static string ToSqlDatetime(this object val)
        {
            CultureInfo cul = new CultureInfo("en-GB");
            try
            {
                ...
                return "'" + (Convert.ToDateTime(val, cul).ToString("yyyy-MM-dd HH:mm:ss")) + "'";
            }
            catch { return "NULL"; }
        }

        public static DataTable ToJson2Datatable(this string val)
        {
            DataTable result = new DataTable();
            try
            {
                result = (DataTable)JsonConvert.DeserializeObject(val, (typeof(DataTable)));
            }
            catch (Exception ex)
            {
        ...
        public static DataTable ToList2DataTable<T>(List<T> items)
        {
        ...
        public static String ToDatatable2Json(this DataTable val)
        {
            string result = string.Empty;
            try
            {
        ...
        public static bool ToBool(this string val)
        {
            ...
            try
            {
                if (val == "1" || val == "True" || val == "true") result = true;
            }
            catch (Exception ex)
            {
        ...
        public static List<T> ToDatatable2List<T>(this DataTable val)
        {
        ...
        public static List<T> ToJson2List<T>(this string val)
        {
            JavaScriptSerializer jss = new JavaScriptSerializer();
            List<T> result = jss.Deserialize<List<T>>(val);
            return result;
        }

        public static T ToJson2Class<T>(this string val)
        {
            JavaScriptSerializer jss = new JavaScriptSerializer();
            T result = jss.Deserialize<T>(val);
            return result;
        }

        public static string ToObj2Json(this object val)
        {
            JavaScriptSerializer jss = new JavaScriptSerializer();
            string result = string.Empty;
            result = jss.Serialize(val);
            return result;
        }
        ...
        public static string ToEncrypt(this string val, bool useHashing)
        {
            byte[] keyArray;
            byte[] toEncryptArray = UTF8Encoding.UTF8.GetBytes(val);
        ...
        public static string ToDecrypt(this string val, bool useHashing)
        {
            byte[] keyArray;
            //get the byte code of the string
            val = val.Replace(" ", "+");
            byte[] toEncryptArray = Convert.FromBase64String(val);
